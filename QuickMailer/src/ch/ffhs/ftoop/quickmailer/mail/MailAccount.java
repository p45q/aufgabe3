...
import ch.ffhs.ftoop.quickmailer.storage.datamanager.adapters.MailAccountAdapter;
...
public class MailAccount {
	...
	public MailAccount(String emailadress, String password, String smtpHost,
			Integer smtpPort, String pop3Host, Integer pop3Port) {
		if (pop3Port == null) {
		...
		folders = new CopyOnWriteArrayList<MailFolder>() {
			{
				add(new MailFolder(L_INBOX, true));
				add(new MailFolder(L_SEND, true));
			}
		};
