	...
	public Boolean checkInputFields() {
		try {
			...
			if (smtpHost.getText().isEmpty() || pop3Host.getText().isEmpty()
					|| mailAdress.getText().isEmpty()
					|| password.getText().isEmpty()) {
				progressLabel
						.setText("Please check your input, all fields are required");
				return false;
			}
			...
			public void actionPerformed(ActionEvent e) {
				if (checkInputFields()) {
					...
					if (editMailAccount != null) {
						...
						editMailAccount.setSmtpPort(Integer.parseInt(smtpPort
								.getText()));
						editMailAccount.setPop3Host(pop3Host.getText());
						editMailAccount.setPop3Port(Integer.parseInt(pop3Port
								.getText()));
					} else {
						// save new mailaccount
						MailAccount newMailAccount = new MailAccount(mailAdress
								.getText(), password.getText(), smtpHost
								.getText(),
								Integer.parseInt(smtpPort.getText()), pop3Host
										.getText(), Integer.parseInt(pop3Port
										.getText()));
